...
from trainer.optimizers import optimizer_func as optim_selector
...
if __name__=='__main__':
    ...
    scheduler = CyclicLR(optimizer, base_lr=config.learning_rate, max_lr=1e-3, cycle_momentum=False)
